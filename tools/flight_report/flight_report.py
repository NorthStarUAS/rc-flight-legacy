...
ax0.plot(r2d(df0_imu['p']), label='p')
ax0.plot(r2d(df0_imu['q']), label='q')
ax0.plot(r2d(df0_imu['r']), label='r')
add_regions(ax0, airborne)
...
ax0.plot(r2d(df0_nav['phi']))
add_regions(ax0, airborne)
add_regions(ax0, regions)
ax0.grid()

ax1.set_ylabel('Pitch (deg)', weight='bold')
ax1.plot(r2d(df0_nav['the']))
add_regions(ax1, airborne)
add_regions(ax1, regions)
ax1.grid()

ax2.set_ylabel('Yaw (deg)', weight='bold')
ax2.plot(r2d(df0_nav['psi']))
...
ax0.plot(r2d(df0_nav['p_bias']), label='p bias')
ax0.plot(r2d(df0_nav['q_bias']), label='q bias')
ax0.plot(r2d(df0_nav['r_bias']), label='r bias')
add_regions(ax0, airborne)
add_regions(ax0, regions)
ax0.grid()
ax0.legend()
