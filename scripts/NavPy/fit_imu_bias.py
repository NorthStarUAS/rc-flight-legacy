...
cal_gyro[0].plot(bias_array[:,1],np.rad2deg(bias_array[:,2]),'*',xvals,np.rad2deg(yvals),label='Filter')
...
cal_gyro[1].plot(bias_array[:,1],np.rad2deg(bias_array[:,3]),'*',xvals,np.rad2deg(yvals), label='Filter')
...
cal_gyro[2].plot(bias_array[:,1],np.rad2deg(bias_array[:,4]),'*',xvals,np.rad2deg(yvals), label='Filter')
...
cal_accel[0].plot(bias_array[:,1],bias_array[:,5],'*',xvals,yvals,label='Filter')
...
cal_accel[1].plot(bias_array[:,1],bias_array[:,6],'*',xvals,yvals,label='Filter')
...
cal_accel[2].plot(bias_array[:,1],bias_array[:,7],'*',xvals,yvals,label='Filter')
