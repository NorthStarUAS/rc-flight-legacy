...
bool fgfs_t::update_imu() {
	...
	imu_node.setDouble( "ax_mps2", nav(0) );
	imu_node.setDouble( "ay_mps2", nav(1) );
	imu_node.setDouble( "az_mps2", nav(2) );
	imu_node.setDouble( "ax_raw", nav(0) );
	imu_node.setDouble( "ay_raw", nav(1) );
	imu_node.setDouble( "az_raw", nav(2) );
