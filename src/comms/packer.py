...
class Packer():
    ...
    def pack_imu_bin(self, use_cached=False):
        ...
        if not use_cached and imu_time > self.last_imu_time:
            ...
            self.imu.p_rad_sec = imu_node.getDouble('p_rad_sec')
            self.imu.q_rad_sec = imu_node.getDouble('q_rad_sec')
            self.imu.r_rad_sec = imu_node.getDouble('r_rad_sec')
            self.imu.ax_mps_sec = imu_node.getDouble('ax_mps_sec')
            self.imu.ay_mps_sec = imu_node.getDouble('ay_mps_sec')
            self.imu.az_mps_sec = imu_node.getDouble('az_mps_sec')
    ...
    def pack_imu_dict(self, index):
        ...
        row['p_rad_sec'] = imu_node.getDouble('p_rad_sec')
        row['q_rad_sec'] = imu_node.getDouble('q_rad_sec')
        row['r_rad_sec'] = imu_node.getDouble('r_rad_sec')
        row['ax_mps_sec'] = imu_node.getDouble('ax_mps_sec')
        row['ay_mps_sec'] = imu_node.getDouble('ay_mps_sec')
        row['az_mps_sec'] = imu_node.getDouble('az_mps_sec')
    ...
    def pack_imu_csv(self, index):
        ...
        row['p_rad_sec'] = '%.4f' % imu_node.getDouble('p_rad_sec')
        row['q_rad_sec'] = '%.4f' % imu_node.getDouble('q_rad_sec')
        row['r_rad_sec'] = '%.4f' % imu_node.getDouble('r_rad_sec')
        row['ax_mps_sec'] = '%.4f' % imu_node.getDouble('ax_mps_sec')
        row['ay_mps_sec'] = '%.4f' % imu_node.getDouble('ay_mps_sec')
        row['az_mps_sec'] = '%.4f' % imu_node.getDouble('az_mps_sec')
    ...
    def unpack_imu_v3(self, buf):
        ...
        node.setDouble("p_rad_sec", imu.p_rad_sec)
        node.setDouble("q_rad_sec", imu.q_rad_sec)
        node.setDouble("r_rad_sec", imu.r_rad_sec)
        node.setDouble("ax_mps_sec", imu.ax_mps_sec)
        node.setDouble("ay_mps_sec", imu.ay_mps_sec)
        node.setDouble("az_mps_sec", imu.az_mps_sec)
