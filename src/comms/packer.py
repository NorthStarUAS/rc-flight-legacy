...
class Packer():
    ...
    def pack_imu_bin(self, use_cached=False):
        ...
        if not use_cached and imu_time > self.last_imu_time:
            ...
            self.imu.ax_nocal = imu_node.getFloat('ax_raw')
            self.imu.ay_nocal = imu_node.getFloat('ay_raw')
            self.imu.az_nocal = imu_node.getFloat('az_raw')
            self.imu.hx_nocal = imu_node.getFloat('hx_raw')
            self.imu.hy_nocal = imu_node.getFloat('hy_raw')
            self.imu.hz_nocal = imu_node.getFloat('hz_raw')
