...
echo "../configure CC=arm-angstrom-linux-gnueabi-gcc CFLAGS=\"-Wall -O3\" CXX=arm-angstrom-linux-gnueabi-g++ CXXFLAGS=\"-Wall -O3\" --host=arm-angstrom-linux-gnueabi --prefix=/usr/local/ugear.overo/"
echo "make"
